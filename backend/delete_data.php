...
if (!isset($data[$primaryKey])) {
    ...
    echo json_encode([
        "success" => false,
        "message" => sprintf("Primary key '%s' is required for deletion.", $primaryKey),
    ]);
    exit;
}

$primaryValue = trim((string) $data[$primaryKey]);
...
if (!$executed) {
    ...
    echo json_encode([
        "success" => false,
        "message" => "Failed to delete record: " . mysqli_stmt_error($stmt),
    ]);
    exit;
}
